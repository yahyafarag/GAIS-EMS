...
import { Plus, Trash2, GripVertical, Settings2, Smartphone, Wrench, Package } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-20">
      <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-l from-indigo-400 to-cyan-400 flex items-center gap-2">
                <Settings2 /> باني نماذج البلاغات
            </h2>
            <p className="text-slate-400 mt-1">أي تغيير هنا ينعكس فوراً على تطبيقات الفروع والفنيين.</p>
          </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
         ...
         <GlassCard className="p-6">
             <h3 className="text-lg font-bold mb-4 border-b border-white/10 pb-2">إعدادات النظام العامة</h3>
         ...
         <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-2 bg-slate-800/50 p-1 rounded-xl border border-white/10">
                ...
                >
                    <Smartphone size={18} /> أسئلة الفرع (Wizard)
                </button>
                <button 
                ...
                >
                    <Wrench size={18} /> إثبات الإصلاح (الفني)
                </button>
            </div>
